...
## E. Visual Studio에서 새 프로젝트 생성 방법
- Visual Studio 를 켜고 **새 프로젝트 만들기** 로 프로젝트를 생성할 수 있음
- **C# Windows 콘솔** 프로젝트를 만들 때는 **새 프로젝트 만들기** 창 중앙 상단에서 언어, 환경 등의 키워드를 설정하면 빠름
- **C# Windows 콘솔**에 나오는 **콘솔 앱** 과 **콘솔 앱(.NET Freamework)** 는 전자가 신버젼, 후자가 구버젼이라는 차이가 있음

<!--
비주얼 스튜디오 기본 사용 방법은 넣지 말자
